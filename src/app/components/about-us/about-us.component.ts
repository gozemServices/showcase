  ...
  gozen = {
    description : {
      p1 : ` Créé en 2015 par des jeunes très ambitieux, GOZEN SERVICE propose des prestations qui couvrent les 
                        ...
                        temporaire et le conseil en organisation. GOZEN s'est donné ainsi pour mission d'apporter des solutions 
                        adaptées pour le positionnement et l'épanouissement professionnel des individus`,
